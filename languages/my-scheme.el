...
(setq swank-chicken-path (concat emacs-root "site-lisp/swank-chicken/swank-chicken.scm"))
...
(defun mit-scheme-init (file encoding)
  (format "%S\n\n"
	  `(begin
	    ...
	    ;; 	    slime-path)
	    ;; 	  (->environment '(swank)))
	    (load (concat emacs-root "site-lisp/slime/contrib/swank-mit-scheme.scm")
		  (->environment '(swank)))
